  ...
  return (
    <div className='w-screen p-8 mt-[6rem] text-justify overflow-y-auto'>
      ...
      <p className='text-lg leading-relaxed'>
        ...
        <br /><br />
        B. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name tedx.aceec.ac.in (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”).
        <br /><br />
        C. The Platform is owned and managed by ACE ENGINEERING COLLEGE, a company incorporated under the Companies Act, 1956 with its registered office at ACE ENGINEERING COLLEGE, Ankushapur, Ghatkesar, Telangana 501301 (hereinafter referred to as &quot;Platform Owner&quot;, “we”, “us”, “our”).
        <br /><br />
        ...
        <br /><br />
        IV. The contents of the Platform and the Services are proprietary to us and are licensed to us. You will not have any authority to claim any intellectual property rights, title, or interest in its contents. The contents include and are not limited to the design, layout, look, and graphics.
        <br /><br />
        ...
        <br /><br />
        VIII. You agree and acknowledge that the website and the Services may contain links to other third-party websites. On accessing these links, you will be governed by the terms of use, privacy policy, and such other policies of such third-party websites. These links are provided for your convenience for providing further information.
        <br /><br />
        ...
        <br /><br />
        XIV. All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Hyderabad, Telangana.
        <br /><br />
